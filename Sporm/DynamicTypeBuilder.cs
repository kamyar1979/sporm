...
public class DynamicTypeBuilder
{
    ...
    {
        var assemblyBuilder =
            AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Utils.OnTheFlyAssemblyName), AssemblyBuilderAccess.Run);
        var moduleBuilder = assemblyBuilder.DefineDynamicModule(Utils.DynamicModuleName);
    ...
    {
        var name = Utils.AnonymousTypePrefix + dict.GetHashCode();
    ...
    public PropertyInfo AddProperty(string name, Type type)
    {
        ...
        var methodGetBuilder = _typeBuilder.DefineMethod(Utils.GetPropertyPrefix + name,
            MethodAttributes.Public | MethodAttributes.SpecialName | MethodAttributes.HideBySig, type,
            Type.EmptyTypes);
        var methodSetBuilder = _typeBuilder.DefineMethod(Utils.SetPropertyPrefix + name,
